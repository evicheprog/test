...
class EFPT1Controller extends Controller
{
    /**
    ...
    public function ProparEtablissement1($id)
    {
          
        $eta_pro= Programm::where('etablissement_id',$id)->get();
        $etablissement = Etablissement::where('id', $id)->get();
      
        return view('EFPT.showProg1',compact('eta_pro','etablissement'));
    }
    public function ProgrammeInfo1($id,$id1,$id2,$id3,$id4,$id5)
    {
        ...
        $programme = Programm::join('programmes','programmes.id','=','programms.programme_id')
         ...
         $programmes = Programm::join('programmes','programmes.id','=','programms.programme_id')
           ->join('filieres','filieres.id','=','programmes.filiere_id')
            ->where('filiere_id', $id)
            ->where('etablissement_id',$id1)
            ->where('anne_niv', $id4)
...
*/
        ...
        return view('EFPT.infoPro1', compact(
            'programme',
            'programmes',
           'id4',
            'dep_eta_sGarcon',
